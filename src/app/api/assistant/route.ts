    ...
    const knowledgeBlock =
      knowledge.length > 0
        ? "\n\n# 社内資料（参考）\n" +
          ...
          "\n" +
          "## この資料を使って答えるときの組み立て方（#82 一般論と社内の見方の違いを示す）\n" +
          "一般的な考え方と、この資料が示す“社内／内田さんならではの見方”が食い違うときは、" +
          "その違いが相手に伝わるように話す。" +
          "例：『一般的には〇〇と言われがちだよね。でも、うちの場合はね…（資料に基づく話）』のように、" +
          "まず世間の見方に軽く触れてから、社内の見方につなぐ。\n" +
          "一般論と社内の見方がほぼ同じで対比の意味が薄いときは、無理に2つに分けず、" +
          "資料に沿って自然に答えてよい。\n" +
          "- 社内の見方として述べる事実は、必ず上の資料の内容に忠実にする。資料に無いことを、" +
